...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BLINK_CHAINPARAMSSEEDS_H\n')
    g.write('#define BLINK_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the blink network\n')
    ...
    g.write('#endif // BLINK_CHAINPARAMSSEEDS_H\n')
