...
echo "export URL=https://github.com/blink-sv/blink-sv.git"
echo "cd gitian-builder"
echo './bin/make-base-vm --lxc --suite xenial --arch amd64'
echo './bin/gbuild --commit blink=${COMMIT} --url blink=${URL} /vagrant/contrib/gitian-descriptors/gitian-linux.yml'