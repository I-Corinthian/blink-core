...
unlocked to sign the Blink-Qt.app bundle.
...
allowing somebody to distribute a Blink-Qt.app or blink-qt-setup.exe with a valid
...
that the blink-qt.exe file inside the installer had not been tampered with.
