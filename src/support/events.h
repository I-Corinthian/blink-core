...
#ifndef BLINK_SUPPORT_EVENTS_H
#define BLINK_SUPPORT_EVENTS_H
...
inline raii_evhttp_connection obtain_evhttp_connection_base(struct event_base *base,
                                                     std::string host,
                                                     uint16_t port) 
{
