...
#ifndef BLINK_ARITH_UINT256_H
#define BLINK_ARITH_UINT256_H
...
public:
     ...
     *
     * Blink only uses this "compact" format for encoding difficulty targets,
