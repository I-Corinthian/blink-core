...
class CompactBlocksTest(BlinkTestFramework):
    ...
    # This test actually causes blinkd to (reasonably!) disconnect us, so do
    # this last.
    ...
    # Test that blinkd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for blinkd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # blinkd will not send blocktxn responses for blocks whose height is
