...
before AND after genesis activation.
...
class BSVGenesisActivationTransactions(ComparisonTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [['-whitelist=127.0.0.1', '-acceptnonstdtxn=0', '-genesisactivationheight=%d' % self.genesisactivationheight]]
    ...
    def get_tests(self):
        ...
        self.assert_rejected_transaction(out[0])
