...
class NetTest(BlinkTestFramework):
    ...
    def _test_getauthconninfo(self):
        acinfo = self.nodes[0].getauthconninfo()
        assert_equal(len(bytearray.fromhex(acinfo['pubkey'])), 33)
        assert_equal(acinfo['compressed'], True)
