...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BlinkTestFramework
    pass


class ExampleTest(BlinkTestFramework):
    # Each functional test is a subclass of the BlinkTestFramework class.
    ...
    def custom_method(self):
        ...
        BlinkTestFramework class so other tests can use it."""
