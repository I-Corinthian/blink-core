Blink-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/blink/files/Blink/blink-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Blink
...
New/changed settings (command-line or blink.conf file)
--------------------------------------------------------
