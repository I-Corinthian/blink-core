Blink version 0.5.4 is now available for download at:
http://sourceforge.net/projects/blink/files/Blink/blink-0.5.4/
...
http://gitorious.org/blink/blinkd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Blink-Qt notifications under Growl 1.3.
Increase required age of Blink-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBlink properly when installing Blink-Qt over it. (Windows)
