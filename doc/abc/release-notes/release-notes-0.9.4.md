Blink Core version 0.9.4 is now available from:

  https://blink.org/bin/0.9.4/
...
this update is incompatible with the Blink system and could lead to consensus
forks.

Blink Core released binaries from https://blink.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~blink/+archive/ubuntu/blink
- A third-party or self-compiled Blink Core

upgrade to Blink Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
