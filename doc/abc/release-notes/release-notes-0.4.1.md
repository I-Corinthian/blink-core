Blink version 0.4.1 is now available for download at:
http://sourceforge.net/projects/blink/files/Blink/blink-0.4.1/
...
If you have a previously encrypted wallet.dat, the first time you run wxblink or blinkd the wallet will be rewritten, Blink will
...
wxBlink: new address visible on main window
