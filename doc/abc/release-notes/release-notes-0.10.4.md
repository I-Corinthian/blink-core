Blink Core version 0.10.4 is now available from:

  <https://blink.org/bin/blink-core-0.10.4/>
...
- #6953 `43c2789` Split blink-tx into its own package
- #6953 `dfe0d4d` Include blink-tx binary on Debian/Ubuntu
