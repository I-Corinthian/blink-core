Blink Core version 0.13.2 is now available from:

  <https://blink.org/bin/blink-core-0.13.2/>
...
- #8908 `4a974b2` Update blink-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow blink-tx to create v2 transactions (btcdrak)
